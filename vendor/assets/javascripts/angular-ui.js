    ...
    return {
        ...
        link: function($scope, element, attrs, controller) {
            ...
            controller.$parsers.push(function(value) {
                ...
                var isValid = element.isMaskValid() || angular.isUndefined(element.isMaskValid()) && element.val()
                    .length > 0;
...
*/
angular.module('ui.directives')
    .directive('uiReset', ['ui.config', function(uiConfig) {
    var resetValue = null;
    ...
    return {
        ...
        link: function(scope, elm, attrs, ctrl) {
            ...
            elm.wrap('<span class="ui-resetwrap" />')
                .after(aElement);
...
**/
angular.module('ui.directives')
    .directive('uiKeydown', ['keypressHelper', function(keypressHelper) {
    return {
        link: function(scope, elm, attrs) {
...
angular.module('ui.directives')
    .directive('uiKeypress', ['keypressHelper', function(keypressHelper) {
    return {
        link: function(scope, elm, attrs) {
...
angular.module('ui.directives')
    .directive('uiKeyup', ['keypressHelper', function(keypressHelper) {
    return {
        link: function(scope, elm, attrs) {
...
*/
angular.module('ui.directives')
    .directive('uiAnimate', ['ui.config', '$timeout', function(uiConfig, $timeout) {
    var options = {};
...
*/
angular.module('ui.directives')
    .directive('uiSelect2', ['ui.config', '$http', function(uiConfig, $http) {
    var options = {};
    if (uiConfig.select2) {
        ...
        compile: function(tElm, tAttrs) {
            ...
            if (tElm.is('select')) {
                ...
                if (repeatOption.length) {
                    ...
                    watch = jQuery.trim(repeatAttr.split('|')[0])
                        .split(' ')
                        .pop();
                }
            }
...
*/
angular.module('ui.directives')
    .directive('uiTinymce', ['ui.config', function(uiConfig) {
        ...
        compile: function(element, attr, linker) {
            return function(scope, iterStartElement, attr) {
                ...
                scope.$watch(expression, function(newValue) {
                    ...
                    iterStartElement.parent()
                        .trigger("$childrenChanged");
                });
            };
        }
    };
    ...
    return {
        link: function(scope, elm, attrs) {
            ...
            angular.element($window)
                .on('scroll.ui-scrollfix', function() {
...
angular.module('ui.directives')
    .directive('uiCalendar', ['ui.config', '$parse', function(uiConfig, $parse) {
        ...
        if (search || angular.isNumber(search)) {
            ...
            if (caseSensitive) {
                return text.split(search)
                    .join('<span class="ui-match">' + search + '</span>');
            } else {
...
angular.module('ui.filters')
    ...
    var inflectors = {
        humanize: function(value) {
            return ucwords(breakup(value, ' ')
                .split('_')
                .join(' '));
        },
        underscore: function(value) {
            return value.substr(0, 1)
                .toLowerCase() + breakup(value.substr(1), '_')
                .toLowerCase()
                .split(' ')
                .join('_');
        },
        variable: function(value) {
            value = value.substr(0, 1)
                .toLowerCase() + ucwords(value.split('_')
                .join(' '))
                .substr(1)
                .split(' ')
                .join('');
